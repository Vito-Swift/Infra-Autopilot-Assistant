...
namespace aruco_mm {
    ...
    public:
        ...
        double optimize(MarkerSet &MarkerSet, FrameSet &FrameSet, const std::set <uint32_t> &fixedMarkers,
                        aruco::CameraParameters &camp, bool fix_cameraparams);
        ...
        toVector(MarkerSet &MarkerSet, FrameSet &FrameSet, aruco::CameraParameters &params);

        void fromVector(SparseLevMarq<double>::eVector &sol, MarkerSet &MarkerSet, FrameSet &FrameSet,
